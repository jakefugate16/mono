	...
	: screenshotLabel(new QLabel(this))
{
	...
	QGroupBox* optionsGroupBox = new QGroupBox(tr("Option"), this);
...
void Screenshot::saveScreenshot()
{
	...
	{
		QMessageBox::warning(this, tr("Save Error"), tr("The image could not be saved tp \"%1\".").arg(QDir::toNativeSeparators(fileName)));
	}
}
